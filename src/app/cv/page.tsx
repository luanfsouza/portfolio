...
export default function Cv() {
  return (
    <div className="flex h-screen">
      <div className="m-auto container lg:pr-20  md:pt-20 md:pr-20 md:pb-20 md:pl-40 border-2 border-blue-800 rounded-2xl">
        <h1 className="text-white text-4xl mb-6 font-bold">
          Luan Ferreira Souza
        </h1>
        <div className="flex justify-between">
          <h3 className="text-xl flex gap-16">
            Acesse:
            <Link
          ...
          <h3 className="text-xl">(77) 98145-1593</h3>
        </div>
        <div className="flex justify-between">
          <h3 className="text-xl flex gap-16 mb-6">
            Acesse:
            <Link
              className="text-blue-800 underline cursor-pointer hover:text-gray-400 duration-300"
          ...
          <h3 className="text-xl">luanferreira7777@gmail.com</h3>
        </div>
        <div className="flex flex-col gap-5 mb-6">
          <h2 className="font-bold text-white text-2xl">Sobre min</h2>
          <p className="text-xl">
        ...
        <div className="flex flex-col gap-5 mb-6">
          <h2 className="font-bold text-white text-2xl">Habilidades</h2>
          <p className="text-xl">
        ...
        <div className="flex flex-col gap-4 mb-6">
          <h2 className="font-bold text-white text-2xl">Projectos</h2>
          <p className="text-xl">
          ...
          <ul className="text-xl flex flex-col pl-10 gap-2">
            <li>
